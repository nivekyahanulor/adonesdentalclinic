                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST"  >
					...
					<div class="col-12">
                      ...
                      <input type="date" name="bday" class="form-control" id="yourName"  autocomplete="off" required>
					...
					<div class="col-12">
                      ...
                      <input type="text" name="number" class="form-control" id="yourMobile"  autocomplete="off" required>
