				...
				<?php while($val = $tbl_appointments->fetch_object()){ ?>
                  <tr>
                    ...
                    <td>
						...
						if($val->approved == 0){ ?>
						<?php if( $dd <= 2) { ?>
								<a href="" data-bs-toggle="modal" data-bs-target="#cancel-no<?php echo $val->id;?>"> PENDING </a> 
						<?php } else { ?>
								<a href="" data-bs-toggle="modal" data-bs-target="#cancel<?php echo $val->id;?>"> PENDING </a> 
						<?php } ?>
