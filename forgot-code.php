            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
					...
					?>
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Enter Code</h5>
					<?php if(isset($_GET['error'])){?>
						<p class="text-center small" style="color:red;">Error!</p>
					<?php } ?>
                  </div>

                  <form class="row g-3 needs-validation" method="post" action="controller/forgot-code.php" novalidate>
